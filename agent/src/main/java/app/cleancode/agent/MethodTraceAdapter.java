...
public class MethodTraceAdapter extends MethodVisitor {
    ...
    public MethodTraceAdapter(int api) {
        super(api);
    }

    public MethodTraceAdapter(int api, MethodVisitor otherVisitor) {
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String descriptor,
        ...
        super.visitMethodInsn(Opcodes.INVOKESTATIC, "app/cleancode/agent/AgentHandler", "pre",
                "(Ljava/lang/String;Ljava/lang/String;Z)V", false);
